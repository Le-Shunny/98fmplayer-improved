# 98FMPlayer Improved
Improved PC-98 FM driver emulation based on myon98's 98FMPlayer
...
* Customizable line and background colors for oscilloscope view
* Configurable oscilloview channel name

## Future plans
* Add RHY view (to replace FM 5 and vice versa) in oscilloview
* Add oscilloview video export support
...
$ make
```
Reads drum sample `ym2608_adpcm_rom.bin` from the directory in which `98fmplayer.exe` is placed.
